...
grader.addBasicPart('3b-1-basic', lambda : grader.requireIsEqual(5, submission.euclideanDistance((0, 3), (4, 0))), description='my test case')
...
def myTest3g():
    # Test around bases cases
    grader.requireIsEqual(6, submission.computeLongestPalindromeLength("abaabaa"))
    grader.requireIsEqual(9, submission.computeLongestPalindromeLength("aallsllaab"))
grader.addBasicPart('3g-0-myTest', myTest3g, description='simple test')
